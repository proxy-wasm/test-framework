...
impl ExpectHandle {
    ...
    pub fn assert_stage(&self) {
        if self.staged.expect_count != 0 {
            panic!("Function call failed to consume all expectations - total remaining: {}", self.staged.expect_count);
        }
    }
...
impl Expect {
    ...
    pub fn set_expect_set_tick_period_millis(&mut self, tick_period_millis: u64) {
        self.expect_count += 1;
        self.tick_period_millis.push(Duration::from_millis(tick_period_millis));
    }
    
    pub fn get_expect_set_tick_period_millis(&mut self) -> Option<u128> {
        match self.tick_period_millis.len() {
            0 => None,
            _ => {self.expect_count -= 1; Some(self.tick_period_millis.remove(0).as_millis())},
        }
    }

    pub fn set_expect_get_current_time_nanos(&mut self, current_time_nanos: u64) {
        self.expect_count += 1;
        self.current_time_nanos.push(UNIX_EPOCH + Duration::from_nanos(current_time_nanos));
    }
    ...
    pub fn get_expect_get_current_time_nanos(&mut self) -> Option<u128> {
        match self.current_time_nanos.len() {
            0 => None,
            _ => {self.expect_count -= 1; 
                  Some(self.current_time_nanos.remove(0).duration_since(UNIX_EPOCH).unwrap().as_nanos())}
        }
    }

    pub fn set_expect_get_buffer_bytes(&mut self, buffer_type: i32, buffer_data: &str) {
        self.expect_count += 1;
        self.get_buffer_bytes.push((buffer_type, buffer_data.as_bytes().to_vec()));
    }
    ...
    pub fn set_expect_get_header_map_pairs(&mut self, map_type: i32, header_map_pairs: Vec<(&str, &str)>) {
        self.expect_count += 1;
        self.get_header_map_pairs.push((map_type, serialize_map(header_map_pairs)));
    }
    ...
    pub fn set_expect_set_header_map_pairs(&mut self, map_type: i32, header_map_pairs: Vec<(&str, &str)>) {
        self.expect_count += 1;
        self.set_header_map_pairs.push((map_type, serialize_map(header_map_pairs)));
    }
    ...
    pub fn set_expect_get_header_map_value(&mut self, map_type: i32, header_map_key: &str, header_map_value: &str) {
        self.expect_count += 1;
        self.get_header_map_value.push((map_type, header_map_key.to_string(), header_map_value.to_string()));
    }

    pub fn get_expect_get_header_map_value(&mut self, map_type: i32, header_map_key: &str) -> Option<String> {
    ...
    pub fn set_expect_replace_header_map_value(&mut self, map_type: i32, header_map_key: &str, header_map_value: &str) {
        self.expect_count += 1;
        self.replace_header_map_value.push((map_type, header_map_key.to_string(), header_map_value.to_string()));
    }

    pub fn get_expect_replace_header_map_value(&mut self, map_type: i32, header_map_key: &str, header_map_value: &str) {
    ...
    pub fn set_expect_remove_header_map_value(&mut self, map_type: i32, header_map_key: &str) {
        self.expect_count += 1;
        self.remove_header_map_value.push((map_type, header_map_key.to_string()));
    }
    ...
    pub fn set_expect_add_header_map_value(&mut self, map_type: i32, header_map_key: &str, header_map_value: &str) {
        self.expect_count += 1;
        self.add_header_map_value.push((map_type, header_map_key.to_string(), header_map_value.to_string()));
    }

    pub fn get_expect_add_header_map_value(&mut self, map_type: i32, header_map_key: &str, header_map_value: &str) {
